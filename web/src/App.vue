    ...
    <div class="container mx-auto">
      <div class="h-screen flex flex-col justify-center items-center">
        <div class="flex flex-col w-fit gap-2 w-full">
          ...
          <div class="bg-[#2f2f2f69] px-3 py-1 rounded-xl max-h-[300px] overflow-y-auto">
            <div v-if="responseComputed && responseComputed.length > 0" class="flex flex-row flex-wrap">
